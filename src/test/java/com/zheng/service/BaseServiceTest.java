...
public class BaseServiceTest {
    ...
    private String to = "791023034@qq.com";  //目标邮件
    ...
    public void sendAttachmentMail() throws Exception {
        ...
        helper.setTo(to);
        helper.setSubject("测试内嵌图片邮件");
        helper.setText("<body>hello springboot,美女呀：<img src='cid:head'></img></body>", true); //内嵌静态图片资源

        FileSystemResource file1 = new FileSystemResource(new File("e:/redis.jpg"));
